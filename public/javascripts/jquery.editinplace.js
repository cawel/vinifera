...
TODO: 
- should be able to disable and re-enable the editor without leaving anything behind
- should be possible to disable the inplace editor for whole dom subtrees (probably another public function...)
