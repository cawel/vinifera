...
steps_for(:ra_resource) do
  ...
  #   "Given a person with login: 'mojojojo'" 
  # produces a Person instance stored in @person with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the person has thac0: 3"
  # takes the earlier-defined @person instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'person'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Person model in the @person instance variable.
#
